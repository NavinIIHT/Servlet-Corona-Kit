...
public class TestUtils {
		...
		public static final String jdbcURL= "jdbc:mysql://localhost/petclinic";
		public static final String jdbcUsername= "petclinic";
	    ...
	    */
	    ...
	    public static int failed;
			...
			static {
				...
				xmlFile = new File("./CoronaKit-Servlet.xml");
				xmlFile.delete();
